    ...
    <form id="msform" onSubmit={handleSubmit(onSubmit)}>
      <fieldset>
        ...
        <div className="text-danger fw-light m-2">
          {errors.name?.type === "pattern" && "There may be additional characters"}
          {errors.name?.type === "required" && "You have not entered your username"}
        ...
        <div className="text-danger fw-light m-2">
          {errors.passwordRepeat?.type === "required" && "Password is obligatory"}
